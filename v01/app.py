...
def initialize_pinecone():
    ...
    PINECONE_API_KEY="58304f4d-8ea7-41da-bd68-2b7e514f8bd9"
...
def create_pinecone_index():
    pinecone.create_index(name=PINECONE_INDEX_NAME, dimension=300, metric="cosine", shards=1)
...
def upload_items(data):
    ...
    print(items_to_upload[0])
    pinecone_index.upsert(vectors=items_to_upload[0:1000])
